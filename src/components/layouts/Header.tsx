...
const Header = (): React.JSX.Element => {
  ...
  return (
    <Wrapper>
      <div className="fixed -translate-x-1/2 left-1/2 z-[99] w-full  md:max-w-[900px]  bg-secondary-black overflow-hidden text-secondary-white  rounded-full sm:h-14 p-4 sm:p-0  flex items-center justify-center gap-4">
        <div className="pages">
