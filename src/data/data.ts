...
export const experienceCardsData: ExperianceCardType[] = [
  ...
  },
  {
    ...
    companyName: "CodSoft",
    detailPara1:
      "During a 1-month virtual internship with CodSoft, I developed and honed my Python programming skills through practical, real-world projects. This internship allowed me to apply theoretical knowledge to solve tangible problems, resulting in the completion of five significant projects.",
    detailPara2:
      "The projects included a To-Do List application, a Calculator, a Password Generator, a Rock Paper Scissors game, and a Contact Management System. I added extra efforts in each project by enhancing features and optimizing performance. This experience strengthened my programming skills, problem-solving abilities, and project management, preparing me for future challenges in software development.",
  },
];
...
export const eductaionCardsData: EductaionCardType[] = [
  {
    ...
    description:
      "Currently in the first year, studying physics, chemistry, and mathematics etc. Course designed by the Government of Sindh Education Department",
  },

  {
    institution: "Governor House Sindh",
    degree:
      "Certified Cloud Applied Generative,Agentic and Robotic AI Engineer",
    fieldOfStudy: "Generative AI and Cloud Computing",
    startDate: "Feb 2024",
    endDate: "Present",
    location: "Karachi, Pakistan",
    description:
      "Pursuing a certification program focused on applied generative AI and cloud engineering. Gaining hands-on experience with AI models, cloud platforms, and real-world applications of generative AI technologies.",
  },
];
